...
export default function ProjectCostsPage() {
  ...
  const [summary, setSummary] =
    useState<ProjectCostSummary | null>(null);
  ...
  async function handleExport() {
    ...
    try {
      const url = materialsCsvExportUrl(
        projectId,
        statusFilter === "all"
          ? undefined
          : statusFilter
      ...
      link.href = objectUrl;
      link.download =
        `project-${projectId}-materials.csv`;
              ...
              <table className="w-full text-sm">
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <td
                      colSpan={4}
                      className="label-mono px-4 py-4 text-right"
                    >
                      Total
                    </td>
                    ...
                    <td
                      className="px-4 py-4 text-right text-lg font-semibold"
                      style={{
                        color:
                          "var(--amber)",
                      }}
